<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountingDetail.aspx.cs" Inherits="AccountNoteFin.SystemAdmin.AccountingDetail" %>
     ...
     <table>
            ...
            <tr>
                ...
                <%--編輯頁面--%>
                    ...
                    <br />
                    <asp:Button ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click" style="height: 21px"/>
                    &nbsp;
